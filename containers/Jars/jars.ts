...
export const PICKLE_JARS = {
  ...
  pDINOWORKUSDC: "" // TODO insert the jar address here
...
export const JAR_DEPOSIT_TOKENS = {
  ...
  [NETWORK_NAMES.POLY]: {
    ...
    POLY_SUSHI_DINO_WORK_USDC: "0xAb0454B98dAf4A02EA29292E6A8882FB2C787DD4",
  },
  [NETWORK_NAMES.OKEX]: {
...
export const DEPOSIT_TOKENS_NAME = {
  ...
  POLY_SUSHI_DINO_WORK_USDC: "SLP WORK/USDC",
...
export const JAR_ACTIVE: Record<string, boolean> = {
  ...
  [DEPOSIT_TOKENS_NAME.POLY_SUSHI_DINO_WORK_USDC]: true,  // should it be marked active?
...
export const DEPOSIT_TOKENS_JAR_NAMES = {
  ...
  POLY_SUSHI_DINO_WORK_USDC: "polyJar 7c",
