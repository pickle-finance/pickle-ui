...
export const PICKLE_JARS = {
  ...
  pSUSHIOPIUMETH: "0xb8390FB0E6c07F6782934474527f253497c7F148",
};
...
export const JAR_DEPOSIT_TOKENS = {
  ...
  SUSHI_OPIUM_ETH: "0xD84d55532B231DBB305908bc5A10B8c55ba21e5E",
...
export const JAR_ACTIVE: Record<string, boolean> = {
  ...
  [DEPOSIT_TOKENS_NAME.SUSHI_OPIUM_ETH]: true,
...
export const getPriceId = (tokenAddress: string): PriceIds => {
  ...
  if (l === "0x888888888889c00c67689029d7856aac1065ec11") {
    return "opium";
  }
