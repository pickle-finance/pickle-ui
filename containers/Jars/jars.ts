...
export const PICKLE_JARS = {
  ...
  pSUSHIIRONUSDC: "0x8b4a32A12AB2088f8feC15234e8066a69183649C",
...
export const JAR_DEPOSIT_TOKENS = {
  ...
  [NETWORK_NAMES.POLY]: {
    ...
    POLY_SUSHI_IRON_USDC: "0x85de135ff062df790a5f20b79120f17d3da63b2d",
...
export const DEPOSIT_TOKENS_NAME = {
  ...
  POLY_SUSHI_IRON_USDC: "SLP IRON/USDC",
  QUICK_MIMATIC_USDC: "QUICK miMATIC/USDC",
};
...
export const JAR_ACTIVE: Record<string, boolean> = {
  ...
  [DEPOSIT_TOKENS_NAME.POLY_SUSHI_IRON_USDC]: true,
...
export const DEPOSIT_TOKENS_LINK = {
  ...
  POLY_SUSHI_IRON_USDC:
    "https://app.sushi.com/add/0xD86b5923F3AD7b585eD81B448170ae026c65ae9a/0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174",
  QUICK_MIMATIC_USDC:
...
export const DEPOSIT_TOKENS_JAR_NAMES = {
  ...
  POLY_SUSHI_IRON_USDC: "polyJar 4c",
