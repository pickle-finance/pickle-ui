...
const UNI_LP_TOKENS = [
  PICKLE_ETH_FARM,
  JAR_DEPOSIT_TOKENS["Ethereum"].UNIV2_ETH_DAI,
  JAR_DEPOSIT_TOKENS["Ethereum"].UNIV2_ETH_USDC,
  JAR_DEPOSIT_TOKENS["Ethereum"].UNIV2_ETH_USDT,
  JAR_DEPOSIT_TOKENS["Ethereum"].UNIV2_ETH_WBTC,
  JAR_DEPOSIT_TOKENS["Ethereum"].UNIV2_BAC_DAI,
  JAR_DEPOSIT_TOKENS["Ethereum"].UNIV2_BAS_DAI,
  JAR_DEPOSIT_TOKENS["Ethereum"].UNIV2_MIR_UST,
  JAR_DEPOSIT_TOKENS["Ethereum"].UNIV2_MTSLA_UST,
  JAR_DEPOSIT_TOKENS["Ethereum"].UNIV2_MAAPL_UST,
  JAR_DEPOSIT_TOKENS["Ethereum"].UNIV2_MQQQ_UST,
  JAR_DEPOSIT_TOKENS["Ethereum"].UNIV2_MSLV_UST,
  JAR_DEPOSIT_TOKENS["Ethereum"].UNIV2_MBABA_UST,
  JAR_DEPOSIT_TOKENS["Ethereum"].UNIV2_FEI_TRIBE,
  JAR_DEPOSIT_TOKENS["Ethereum"].UNIV2_LUSD_ETH,
];
