...
interface JarsymbioticInterface extends ethers.utils.Interface {
  functions: {
    ...
    "curPendingReward()": FunctionFragment;
    ...
    "pendingRewardOfUser(address)": FunctionFragment;
    ...
    "userRewardDebt(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "curPendingReward",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "pendingRewardOfUser",
    values: [string]
  ): string;
...
export class Jarsymbiotic extends Contract {
  ...
  interface: JarsymbioticInterface;
  ...
  functions: {
    ...
    curPendingReward(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  userRewardDebt(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  filters: {
    ...
    Deposit(
      ...
      { user: string; _amount: BigNumber; _shares: BigNumber }
    >;
  ...
  populateTransaction: {
    ...
    curPendingReward(overrides?: CallOverrides): Promise<PopulatedTransaction>;
