...
interface JarTimelockInterface extends ethers.utils.Interface {
  functions: {
    ...
    "cooldownStartTime(address)": FunctionFragment;
    ...
    "initialWithdrawalFee()": FunctionFragment;
    "initialWithdrawalFeeMax()": FunctionFragment;
    ...
    "setInitialWithdrawalFee(uint256,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "cooldownStartTime",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "initialWithdrawalFee",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "initialWithdrawalFeeMax",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "setInitialWithdrawalFee",
...
export class JarTimelock extends Contract {
  ...
  interface: JarTimelockInterface;
  ...
  functions: {
    ...
    initialWithdrawalFee(overrides?: CallOverrides): Promise<[BigNumber]>;

    "initialWithdrawalFee()"(overrides?: CallOverrides): Promise<[BigNumber]>;

    initialWithdrawalFeeMax(overrides?: CallOverrides): Promise<[BigNumber]>;

    "initialWithdrawalFeeMax()"(
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
    ...
    setInitialWithdrawalFee(
      fee: BigNumberish,
      feeMax: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    "setInitialWithdrawalFee(uint256,uint256)"(
      fee: BigNumberish,
      feeMax: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
