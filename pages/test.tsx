...
const Test: FC = () => (
  <div>
    ...
    <p>
      <s>This is deleted (strikethrough) text, made with strike.</s>{" "}
    ...
    <p>
      This is an abbreviation, made with abbr: <abbr>WWW</abbr>. This is a term
      that needs a definition, made with dfn: <dfn>Yog-Sothoth</dfn>.
    </p>
