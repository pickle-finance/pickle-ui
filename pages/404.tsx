...
const NotFound: PickleFinancePage = () => {
  ...
  return (
    <div className="flex justify-center items-center py-8 lg:py-32">
      <div
        className="bg-background-light w-4/5 lg:w-1/2 max-w-xl rounded-xl border border-foreground-alt-500 shadow p-6 md:p-12"
      >
        ...
        <div className="w-full text-center mb-8">
          <p className="break-normal font-bold text-foreground-alt-200">{t("v2.error404.noPickles")}</p>
        </div>
        <div className="w-full text-center mb-8">
